...
const SuccessPurchase = ({
  ...
  return (
    <svg
      class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1aah3z4"
      width={width}
      height={height}
      focusable="false"
      aria-hidden="true"
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="16.69%"
        >
          <stop offset="0%" stop-color={colorMain}></stop>
          <stop offset="100%" stop-color={colorMain} stop-opacity="0"></stop>
        </linearGradient>
      </defs>
      <path
        fill="url(#:r5f:)"
      ...
      ></path>
      <image
        href="https://assets.minimals.cc/public/assets/illustrations/characters/character-10.webp"
        height="300"
        x="300"
        y="30"
      ></image>
      ...
      <defs>
        ...
        >
          <stop stop-color={colorMain}></stop>
          <stop offset="1" stop-color={colorDark}></stop>
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stop-color={colorLight}></stop>
          <stop offset="1" stop-color={colorDark}></stop>
        </linearGradient>
        <linearGradient
